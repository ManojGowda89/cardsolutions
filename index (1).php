...
<body >
  ...
  <div class="alert alert-primary alert-dismissible fade show" role="alert">
   <center> <strong>Welcome To Card_Solutions </strong></center>    
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
    <div id="sub"></div>
    <div class="container d-flex align-items-center">

      <h1 class="logo me-auto"><a href="index.php">Card_solutions</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="create.php">Create Accountt</a></li>
    ...
    <div class="container">
      <div class="row">
       ...
       <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="userlogin.php" class="btn-get-started scrollto">Login</a>
    ...
    <div class="footer-top">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact" id="co">
